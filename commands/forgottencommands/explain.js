...
const { MessageActionRow, AttachmentBuilder, EmbedBuilder} = require('discord.js');
...
module.exports = {
    ...
    async execute(interaction) {
        await interaction.deferReply()
            const file = new AttachmentBuilder(`./images/CARDS/STAFF/KsisiosSTAFF.jpg`);
            const file2 = new AttachmentBuilder(`./images/CARDS/category.jpg`);
            ...
            .addFields({name : "", value: "ATTENTION', 'Il s\'agit de la version 1.0, par la suite nous prévoyons d\'ajouter de nouvelles choses.'"})
            ...
            .addFields({name : "", value: "ATTENTION', 'De nouvelles façons d\'obtenir des JA points sont en préparation (participation aux cours, events, qcm, validation de leçon)."})
            .setFooter({ text: 'Yumeko à votre service !'})
        ...
        interaction.editReply({ embeds: [embed, embed1, embed2, embed3, embed4, embed5, embed6], files: [file, file2], ephemeral:false}) 
    },
};