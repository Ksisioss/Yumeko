...
function getCard(member, rarity, error, randomtab, interaction) {
    ...
    if (err) throw err;
        ...
        insertCard(member, rarity, error, randomtab, interaction)
    });    
};
...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        async drop(interaction) {
            ...
            var member = interaction.member
            //console.log(member)
            getCard(member, rarity, error, randomtab, interaction)
